        ...
        execute: function() {
            CreateComponent = (function () {
                ...
                CreateComponent.prototype.create = function () {
                    var _this = this;
                    this._coursesService.create(this.course).subscribe(function (createdCourse) { return _this._router.navigate(['/courses', createdCourse._id]); }, function (error) { return _this.errorMessage = error; });
                };
