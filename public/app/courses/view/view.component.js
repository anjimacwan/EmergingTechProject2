        ...
        execute: function() {
            ViewComponent = (function () {
                ...
                ViewComponent.prototype.ngOnInit = function () {
                    ...
                    this.routingObserver = this._route.params.subscribe(function (params) {
                        ...
                        _this._coursesService
                            ...
                            _this.course = course;
                            _this.allowEdit = (_this.user && _this.user._id === _this.course.creator._id);
                ...
                ViewComponent.prototype.delete = function () {
                    var _this = this;
                    this._coursesService.delete(this.course._id).subscribe(function (deletedCourse) { return _this._router.navigate(['/courses']); }, function (error) { return _this.errorMessage = error; });
                };
