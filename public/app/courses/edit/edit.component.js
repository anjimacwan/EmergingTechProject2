        ...
        execute: function() {
            EditComponent = (function () {
                ...
                EditComponent.prototype.update = function () {
                    var _this = this;
                    this._coursesService.update(this.course).subscribe(function (savedCourse) { return _this._router.navigate(['/courses', savedCourse._id]); }, function (error) { return _this.errorMessage = error; });
                };
