System.register(['@angular/core', '../authentication/authentication.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            MotivationComponent = (function () {
                function MotivationComponent(_authenticationService) {
            ...
            exports_1("MotivationComponent", MotivationComponent);
        }
    }
});
